...
export const Checkout = memo(function Checkout({
  ...
  return (
    <section className="self-start w-full h-full bg-primary p-6 text-white shadow-xl sm:p-8 md:col-span-5 md:sticky md:top-6 flex flex-col">
      <form
      ...
      >
        ...
        <div className="mt-auto shrink-0 pt-4">
          {totalPrice > 0 && (
            <Input.Root>
              <Input.Label className="text-sm font-bold text-slate-200">
          ...
          <div className="flex items-center justify-between gap-3 pt-6">
            <div className="flex flex-col gap-1 text-sm text-white/85">
              ...
              <strong className="text-3xl">{money(totalPrice)}</strong>
            </div>
